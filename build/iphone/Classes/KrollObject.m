 ...
 * Copyright (c) 2009-2011 by TaskSoldier, Inc. All Rights Reserved.
...
//@interface TaskSoldierObject : NSObject
//@end

@interface TaskSoldierObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TaskSoldierObject class]])
		{
			for (NSString *key in [[(TaskSoldierObject*)o modules] allKeys])
			{
