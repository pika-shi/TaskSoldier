...
// in simulator we redefine to format for TaskSoldier Developer console
...
{\
	NSString * exceptionName = [@"org.tasksoldier." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tasksoldier";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITaskSoldierNativeItemNone = -1, 
	UITaskSoldierNativeItemSpinner = -2,
	UITaskSoldierNativeItemProgressBar = -3,
	
	UITaskSoldierNativeItemSlider = -4,
	UITaskSoldierNativeItemSwitch = -5,
	UITaskSoldierNativeItemMultiButton = -6,
	UITaskSoldierNativeItemSegmented = -7,
	
	UITaskSoldierNativeItemTextView = -8,
	UITaskSoldierNativeItemTextField = -9,
	UITaskSoldierNativeItemSearchBar = -10,
	
	UITaskSoldierNativeItemPicker = -11,
	UITaskSoldierNativeItemDatePicker = -12,
	
	UITaskSoldierNativeItemInfoLight = -13,
	UITaskSoldierNativeItemInfoDark = -14,
	
	UITaskSoldierNativeItemDisclosure = -15,
	
	UITaskSoldierNativeItemContactAdd = -16
};
