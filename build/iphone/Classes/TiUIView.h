...
/**
 Base class for all TaskSoldier views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TaskSoldier view hierarchy (such as wrapped iOS UIViews) was touched.
