var TaskDB = function() {
    ...
    this.db.execute('CREATE TABLE IF NOT EXISTS task ( id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, deadline TEXT, importance INTEGER, memo TEXT, passedtime TEXT, endtime TEXT, endflag INTEGER)');
    this.close();
};
