...
var optionPickerDialog = ( function() {
		...
		function createControls() {
			...
			coverViewOpenAnimation = Ti.UI.createAnimation({
				opacity : 0.5
			});
			coverViewCloseAnimation = Ti.UI.createAnimation({
				opacity : 0
			});
			containerViewOpenAnimation = Ti.UI.createAnimation({
				bottom : 0
			});
			containerViewCloseAnimation = Ti.UI.createAnimation({
				bottom : -251
			});
